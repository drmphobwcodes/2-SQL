...
-- A:Will create a new table called employees_categories that will have a foreign key to the employees table and a 
--foreign key to the categories table. to keep track of who is an expert in what.

-- Q: What type of relationship is this? (e.g. 1-1, 1-many, or many-to-many?)
-- A: This type of relationship is many-to-many.
